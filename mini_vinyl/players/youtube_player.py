...
CPU (tens of seconds). Since a given vinyl always plays the same URL, the
first play streams live as before but also kicks off a background
download to a local cache; every later play of that same tag finds the
cached file and starts near-instantly.
"""
